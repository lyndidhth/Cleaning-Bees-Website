...
- Added More Content: Expanded the "About Us" and "Services" sections to include detailed descriptions, pricing, and service categories.
- Enhanced Layout*: Updated HTML structure for better readability and flow across all pages.
- Professional Styling: Refined the CSS to use a consistent green and grey palette, improved spacing, and added animations for a polished look.
- Bubble Background: Introduced a subtle animated bubble effect to reinforce the brand’s clean and fresh identity.
- Responsive Design: Ensured the site looks great on desktop and mobile devices.

## 📄 Pages Included

- index.html – Homepage with brand intro and key features
...
- enquiries.html – Placeholder for future client queries
- robottxt
- script.js
- sitemap.xml
...
- Add client testimonials and gallery
- Integrate WhatsApp contact button
- Include backend form handling with Node.js 

1. Harvard University. (n.d.) CS50’s Web Programming with Python and JavaScript. 
2. W3Schools. (n.d.) CSS Tutorial. 
3. Mozilla Developer Network. (n.d.) CSS: Cascading Style Sheets. 
4. FreeCodeCamp. (n.d.) Responsive Web Design Certification. 
   

---

After feedback
Created one css file
Made it more fitting
rearranged bttons
Removed the bubbles image
Added more colour
